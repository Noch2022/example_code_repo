    ...
    <div class="sms_att_daily_operation">
        <form action="" name="" id="" method="">
            <div class="sms_row sms_main_info">
                <div class="dflex">
                    <p class="text_current_date">Start Date:</p>
                    <input type="text" class="current_Date"/>
                </div>

                <div class="dflex">
                    <p class="text_current_date">End Date:</p>
                    <input type="text" class="current_Date"/>
                </div>
            ...
            <table class="table table-bordered table-collapsed table-striped">
                <thead>
                    <tr>
                        <th rowspan="2" style="width: 15%" class="textCenter">Emp Name</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="view_operation">
                               <a href="/listing_attendance_detail">View</a>
                            </div>
                        </td>
                    </tr>
                    @endfor
